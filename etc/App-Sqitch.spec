...
BuildRequires:  perl%{plv}(Locale::Messages)
...
BuildRequires:  perl%{plv}(URI::db) >= 0.19
...
Requires:       perl%{plv}(Locale::Messages)
...
Requires:       perl%{plv}(DBI)
Requires:       perl%{plv}(DBD::ODBC) >= 1.59
